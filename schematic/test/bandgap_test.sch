...
N -140 320 -110 320 { lab=#net2}
N -110 230 -110 320 { lab=#net2}
...
N -420 180 -420 310 { lab=#net3}
N -420 180 -160 180 { lab=#net3}
N -580 120 -160 120 { lab=#net4}
N -580 120 -580 250 { lab=#net4}
N -180 -20 -180 40 { lab=#net1}
N -180 -20 20 -20 { lab=#net1}
N 20 -20 20 150 { lab=#net1}
N -550 40 -390 40 { lab=#net1}
N -390 40 -180 40 { lab=#net1}
N -420 70 -420 180 { lab=#net3}
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/ibias.sym} -190 340 0 0 {name=X1 Wp=Wp Lp=Lp WW=WW LL=LL}
C {madvlsi/isource.sym} -240 370 0 1 {name=I2
value=\{Iref\}}
C {madvlsi/gnd.sym} -240 400 0 1 {name=l12 lab=GND}
...
C {devices/code_shown.sym} -30 520 0 0 {name=SPICE only_toplevel=false value=".param Iref=0.5u n=5 
...
.control
  ...
  while currTemp <= endTemp
    ...
    save v(Vbep) v(Vben)
    op
    wrdata ~/Documents/MADVLSI-Final_Project/schematic/data/bandgap-20-100C.csv v(Vbep) v(Vben) currTemp
