...
N -360 130 -320 130 { lab=Vref}
N -260 130 -180 130 { lab=#net2}
...
C {devices/lab_pin.sym} -360 130 0 0 {name=l8 sig_type=std_logic lab=Vref}
C {madvlsi/resistor.sym} -290 130 1 0 {name=R2
value=15M
m=1}
C {madvlsi/capacitor.sym} -220 100 2 0 {name=C2
value=15p
m=1}
C {madvlsi/gnd.sym} -220 70 2 0 {name=l9 lab=GND}
