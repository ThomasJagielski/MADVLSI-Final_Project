...
N -1180 -330 -930 -330 { lab=#net1}
N -1180 -420 -1180 -330 { lab=#net1}
N -1300 -620 -930 -620 { lab=Vphi1gen}
N -1180 -620 -1180 -520 { lab=Vphi1gen}
N -750 -360 -680 -360 { lab=#net2}
N -750 -590 -680 -590 { lab=#net3}
N -580 -590 -540 -590 { lab=#net4}
N -440 -590 -400 -590 { lab=#net5}
N -580 -360 -540 -360 { lab=#net6}
N -440 -360 -400 -360 { lab=#net7}
N -960 -560 -930 -560 { lab=#net7}
N -960 -560 -960 -500 { lab=#net7}
N -960 -500 -400 -500 { lab=#net7}
N -400 -500 -400 -360 { lab=#net7}
N -440 -590 -440 -450 { lab=#net5}
N -960 -450 -440 -450 { lab=#net5}
N -960 -450 -960 -390 { lab=#net5}
N -960 -390 -930 -390 { lab=#net5}
...
N 300 60 300 240 { lab=#net8}
N 300 240 390 240 { lab=#net8}
N 0 60 40 60 { lab=Vref}
N 250 60 310 60 { lab=#net8}
N 0 0 40 0 { lab=Vin}
N 60 20 60 110 { lab=Vphi1}
N 80 20 80 110 { lab=Vnphi1}
N 210 20 210 110 { lab=Vphi2}
N 230 20 230 110 { lab=Vnphi2}
N 100 -0 190 -0 { lab=#net9}
N 100 60 190 60 { lab=#net10}
N 310 60 310 80 { lab=#net8}
N 310 80 350 80 { lab=#net8}
N 250 0 310 -0 { lab=#net11}
N 310 -20 310 -0 { lab=#net11}
N 310 -20 350 -20 { lab=#net11}
N -900 340 -800 340 { lab=Vbp}
N -800 370 -800 400 { lab=Vbn}
N -800 370 -770 370 { lab=Vbn}
N 480 50 520 50 { lab=Vout}
N 510 50 510 240 { lab=Vout}
...
value=5p
m=1}
C {devices/lab_pin.sym} 520 50 2 0 {name=l2 sig_type=std_logic lab=Vout}
...
C {devices/lab_pin.sym} 350 10 0 0 {name=l19 sig_type=std_logic lab=Vbp}
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/fully_differential_sc_amp.sym} 460 -10 0 0 {name=X1 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {devices/lab_pin.sym} 350 30 0 0 {name=l7 sig_type=std_logic lab=Vref}
C {madvlsi/pmos3.sym} -770 340 0 0 {name=M1
L=1
W=5
body=VDD
nf=1
...
C {madvlsi/vdd.sym} -770 310 0 0 {name=l16 lab=VDD}
C {madvlsi/nmos3.sym} -770 400 0 0 {name=M2
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} -770 430 0 0 {name=l17 lab=GND}
C {devices/lab_pin.sym} -800 400 0 0 {name=l18 sig_type=std_logic lab=Vbn}
C {devices/lab_pin.sym} 350 50 0 0 {name=l20 sig_type=std_logic lab=Vbn}
