...
N -1360 -2190 -1360 -2150 { lab=0clk}
N -1480 -2290 -1480 -2150 { lab=0clk}
N -990 -2190 -990 -2150 { lab=0clk}
N -1110 -2290 -1110 -2150 { lab=0clk}
N -620 -2190 -620 -2150 { lab=0clk}
N -740 -2290 -740 -2150 { lab=0clk}
N -250 -2190 -250 -2150 { lab=0clk}
N -370 -2290 -370 -2150 { lab=0clk}
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} -1360 -2230 3 0 {name=X6 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/vdd.sym} -1400 -2230 3 0 {name=l7 lab=VDD}
C {madvlsi/gnd.sym} -1320 -2230 3 0 {name=l8 lab=GND}
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} -990 -2230 3 0 {name=X9 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/vdd.sym} -1030 -2230 3 0 {name=l11 lab=VDD}
C {madvlsi/gnd.sym} -950 -2230 3 0 {name=l12 lab=GND}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} -620 -2230 3 0 {name=X12 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/vdd.sym} -660 -2230 3 0 {name=l15 lab=VDD}
C {madvlsi/gnd.sym} -580 -2230 3 0 {name=l16 lab=GND}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} -250 -2230 3 0 {name=X15 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/vdd.sym} -290 -2230 3 0 {name=l20 lab=VDD}
C {madvlsi/gnd.sym} -210 -2230 3 0 {name=l21 lab=GND}
