...
S {}
E {}
N 1120 -1100 1440 -1100 { lab=#net1}
N 1440 -1100 1760 -1100 { lab=#net1}
N 1760 -1100 2080 -1100 { lab=#net1}
N 4040 -1100 4120 -1100 { lab=Qout}
N 3870 -1100 3940 -1100 { lab=#net2}
N 3690 -1100 3770 -1100 { lab=Qout-pre-buffer}
N 3460 -1100 3690 -1100 { lab=Qout-pre-buffer}
...
N 980 -510 1110 -510 { lab=#net3}
N 1200 -560 1340 -560 { lab=Q1}
N 1430 -560 1580 -560 { lab=Q2}
N 1200 -510 1340 -510 { lab=#net4}
N 1430 -510 1580 -510 { lab=#net5}
...
N 1010 -1100 1010 -1090 { lab=#net1}
N 800 -1100 800 -1090 { lab=#net1}
N 800 -1100 1120 -1100 { lab=#net1}
N 1410 -1100 1410 -1090 { lab=#net1}
N 1200 -1100 1200 -1090 { lab=#net1}
N 1820 -1100 1820 -1090 { lab=#net1}
N 1610 -1100 1610 -1090 { lab=#net1}
N 2010 -1100 2010 -1090 { lab=#net1}
N 2020 -1180 2090 -1180 { lab=#net18}
N 2120 -1150 2120 -1100 { lab=#net1}
N 2500 -1100 2820 -1100 { lab=#net1}
N 2820 -1100 3140 -1100 { lab=#net1}
N 3140 -1100 3460 -1100 { lab=#net1}
N 2390 -1100 2390 -1090 { lab=#net1}
N 2180 -1100 2180 -1090 { lab=#net1}
N 2180 -1100 2500 -1100 { lab=#net1}
N 2790 -1100 2790 -1090 { lab=#net1}
N 2580 -1100 2580 -1090 { lab=#net1}
N 3200 -1100 3200 -1090 { lab=#net1}
N 2990 -1100 2990 -1090 { lab=#net1}
N 3390 -1100 3390 -1090 { lab=#net1}
N 2080 -1100 2180 -1100 { lab=#net1}
N 3360 -1180 3430 -1180 { lab=#net19}
N 3460 -1150 3460 -1100 { lab=#net1}
...
C {devices/lab_pin.sym} 4120 -1100 1 0 {name=l95 sig_type=std_logic lab=Qout}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 3810 -1100 0 0 {name=X27 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 3980 -1100 0 0 {name=X28 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/gnd.sym} 3810 -1060 0 0 {name=l111 lab=GND}
C {madvlsi/vdd.sym} 3810 -1140 0 0 {name=l112 lab=VDD}
C {madvlsi/gnd.sym} 3980 -1060 0 0 {name=l113 lab=GND}
C {madvlsi/vdd.sym} 3980 -1140 0 0 {name=l114 lab=VDD}
C {devices/lab_pin.sym} 3690 -1100 1 0 {name=l115 sig_type=std_logic lab=Qout-pre-buffer}
...
C {madvlsi/nmos3.sym} 800 -1060 0 0 {name=M1
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 800 -1030 0 0 {name=l5 lab=GND}
C {devices/lab_pin.sym} 770 -1060 0 0 {name=l11 sig_type=std_logic lab=Q0}
C {madvlsi/nmos3.sym} 1010 -1060 0 0 {name=M2
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 1010 -1030 0 0 {name=l14 lab=GND}
C {devices/lab_pin.sym} 980 -1060 0 0 {name=l17 sig_type=std_logic lab=Q1}
C {madvlsi/nmos3.sym} 1200 -1060 0 0 {name=M5
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 1200 -1030 0 0 {name=l18 lab=GND}
C {devices/lab_pin.sym} 1170 -1060 0 0 {name=l20 sig_type=std_logic lab=Q2}
C {madvlsi/nmos3.sym} 1410 -1060 0 0 {name=M7
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 1410 -1030 0 0 {name=l21 lab=GND}
C {devices/lab_pin.sym} 1380 -1060 0 0 {name=l24 sig_type=std_logic lab=Q3}
C {madvlsi/nmos3.sym} 1610 -1060 0 0 {name=M9
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 1610 -1030 0 0 {name=l35 lab=GND}
C {devices/lab_pin.sym} 1580 -1060 0 0 {name=l39 sig_type=std_logic lab=Q4}
C {madvlsi/nmos3.sym} 1820 -1060 0 0 {name=M11
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 1820 -1030 0 0 {name=l43 lab=GND}
C {devices/lab_pin.sym} 1790 -1060 0 0 {name=l45 sig_type=std_logic lab=Q5}
C {madvlsi/nmos3.sym} 2010 -1060 0 0 {name=M13
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 2010 -1030 0 0 {name=l57 lab=GND}
C {devices/lab_pin.sym} 1980 -1060 0 0 {name=l61 sig_type=std_logic lab=Q6}
C {madvlsi/pmos3.sym} 2120 -1180 0 0 {name=M14
L=0.15
W=1
body=VDD
nf=1
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 1960 -1180 0 0 {name=X1 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/gnd.sym} 1960 -1140 0 0 {name=l65 lab=GND}
C {madvlsi/vdd.sym} 1960 -1220 0 0 {name=l69 lab=VDD}
C {madvlsi/vdd.sym} 2120 -1210 0 0 {name=l74 lab=VDD}
C {devices/lab_pin.sym} 1920 -1180 0 0 {name=l75 sig_type=std_logic lab=Q7}
C {madvlsi/nmos3.sym} 2180 -1060 0 0 {name=M3
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 2180 -1030 0 0 {name=l49 lab=GND}
C {devices/lab_pin.sym} 2150 -1060 0 0 {name=l53 sig_type=std_logic lab=Q8}
C {madvlsi/nmos3.sym} 2390 -1060 0 0 {name=M4
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 2390 -1030 0 0 {name=l73 lab=GND}
C {devices/lab_pin.sym} 2360 -1060 0 0 {name=l77 sig_type=std_logic lab=Q9}
C {madvlsi/nmos3.sym} 2580 -1060 0 0 {name=M6
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 2580 -1030 0 0 {name=l78 lab=GND}
C {devices/lab_pin.sym} 2550 -1060 0 0 {name=l79 sig_type=std_logic lab=Q10}
C {madvlsi/nmos3.sym} 2790 -1060 0 0 {name=M8
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 2790 -1030 0 0 {name=l80 lab=GND}
C {devices/lab_pin.sym} 2760 -1060 0 0 {name=l81 sig_type=std_logic lab=Q11}
C {madvlsi/nmos3.sym} 2990 -1060 0 0 {name=M10
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 2990 -1030 0 0 {name=l82 lab=GND}
C {devices/lab_pin.sym} 2960 -1060 0 0 {name=l83 sig_type=std_logic lab=Q12}
C {madvlsi/nmos3.sym} 3200 -1060 0 0 {name=M12
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 3200 -1030 0 0 {name=l84 lab=GND}
C {devices/lab_pin.sym} 3170 -1060 0 0 {name=l85 sig_type=std_logic lab=Q13}
C {madvlsi/nmos3.sym} 3390 -1060 0 0 {name=M15
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 3390 -1030 0 0 {name=l86 lab=GND}
C {devices/lab_pin.sym} 3360 -1060 0 0 {name=l87 sig_type=std_logic lab=Q14}
C {madvlsi/pmos3.sym} 3460 -1180 0 0 {name=M16
L=0.15
W=1
body=VDD
nf=1
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 3300 -1180 0 0 {name=X18 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/gnd.sym} 3300 -1140 0 0 {name=l88 lab=GND}
C {madvlsi/vdd.sym} 3300 -1220 0 0 {name=l89 lab=VDD}
C {madvlsi/vdd.sym} 3460 -1210 0 0 {name=l90 lab=VDD}
C {devices/lab_pin.sym} 3260 -1180 0 0 {name=l91 sig_type=std_logic lab=Q15}
