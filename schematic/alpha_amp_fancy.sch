...
N 890 -720 1050 -720 { lab=CLK}
N 920 -690 970 -690 { lab=#net3}
N 970 -690 1020 -690 { lab=#net3}
N 1080 -690 1150 -690 { lab=Vg2}
...
C {madvlsi/nmos3.sym} 890 -690 1 0 {name=M3
L=LL
W=WW
body=GND
nf=1
...
C {madvlsi/nmos3.sym} 1050 -690 1 0 {name=M4
L=LL
W=WW
body=GND
nf=1
...
C {devices/lab_pin.sym} 890 -720 1 0 {name=l59 sig_type=std_logic lab=CLK}
