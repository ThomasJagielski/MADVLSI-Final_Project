...
N 620 -560 890 -560 { lab=Q16}
N 860 -510 890 -510 { lab=nQ16}
...
N 4760 -470 4760 -350 { lab=CLK}
N 4520 -350 4760 -350 { lab=CLK}
N 4730 -610 4730 -590 { lab=VDD}
N 1290 -1180 1360 -1180 { lab=#net17}
N 1610 -1180 1680 -1180 { lab=#net18}
N 1390 -1150 1390 -1090 { lab=Qout-pre-buffer}
N 1390 -1100 1710 -1100 { lab=Qout-pre-buffer}
N 1710 -1150 1710 -1090 { lab=Qout-pre-buffer}
N 1930 -1180 2000 -1180 { lab=#net19}
N 1710 -1100 2030 -1100 { lab=Qout-pre-buffer}
N 2030 -1150 2030 -1090 { lab=Qout-pre-buffer}
N 2250 -1180 2320 -1180 { lab=#net20}
N 2030 -1100 2350 -1100 { lab=Qout-pre-buffer}
N 2350 -1150 2350 -1090 { lab=Qout-pre-buffer}
N 2570 -1180 2640 -1180 { lab=#net21}
N 2350 -1100 2670 -1100 { lab=Qout-pre-buffer}
N 2670 -1150 2670 -1090 { lab=Qout-pre-buffer}
N 2890 -1180 2960 -1180 { lab=#net22}
N 2670 -1100 2990 -1100 { lab=Qout-pre-buffer}
N 2990 -1150 2990 -1090 { lab=Qout-pre-buffer}
N 3210 -1180 3280 -1180 { lab=#net23}
N 2990 -1100 3310 -1100 { lab=Qout-pre-buffer}
N 3310 -1150 3310 -1090 { lab=Qout-pre-buffer}
N 3530 -1180 3600 -1180 { lab=#net24}
N 3310 -1100 3630 -1100 { lab=Qout-pre-buffer}
N 3630 -1150 3630 -1090 { lab=Qout-pre-buffer}
N 3630 -1100 3860 -1100 { lab=Qout-pre-buffer}
N 4210 -1100 4290 -1100 { lab=Qout}
N 4040 -1100 4110 -1100 { lab=#net25}
N 3860 -1100 3940 -1100 { lab=Qout-pre-buffer}
N 4790 -510 4860 -510 { lab=nQ16}
N 4860 -510 4860 -300 { lab=nQ16}
N 590 -300 4860 -300 { lab=nQ16}
N 590 -510 860 -510 { lab=nQ16}
N 590 -510 590 -300 { lab=nQ16}
N 4790 -560 4860 -560 { lab=Q16}
N 4860 -710 4860 -560 { lab=Q16}
N 590 -560 620 -560 { lab=Q16}
N 590 -710 4860 -710 { lab=Q16}
N 590 -710 590 -560 { lab=Q16}
...
.ic v(Q15)=0 v(X17.Qi)=1.8
.ic v(Q16)=1.8 v(X18.Qi)=0 v(nQ16)=0
.tran 10u 1m
.save all"}
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/CSRL_D_FF.sym} 4650 -530 0 0 {name=X18}
C {madvlsi/gnd.sym} 4730 -470 0 0 {name=l14 lab=GND}
C {madvlsi/vdd.sym} 4730 -610 0 0 {name=l17 lab=VDD}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/CSRL_D_FF.sym} 4410 -530 0 0 {name=X17}
C {madvlsi/pmos3.sym} 1390 -1180 0 0 {name=M1
L=0.15
W=1
body=VDD
nf=1
...
C {madvlsi/pmos3.sym} 1710 -1180 0 0 {name=M2
L=0.15
W=1
body=VDD
nf=1
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 1230 -1180 0 0 {name=X19 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 1550 -1180 0 0 {name=X20 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/nmos3.sym} 1390 -1060 0 0 {name=M3
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/nmos3.sym} 1710 -1060 0 0 {name=M4
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 1230 -1140 0 0 {name=l18 lab=GND}
C {madvlsi/vdd.sym} 1230 -1220 0 0 {name=l20 lab=VDD}
C {madvlsi/gnd.sym} 1550 -1140 0 0 {name=l35 lab=GND}
C {madvlsi/vdd.sym} 1550 -1220 0 0 {name=l39 lab=VDD}
C {madvlsi/vdd.sym} 1390 -1210 0 0 {name=l43 lab=VDD}
C {madvlsi/vdd.sym} 1710 -1210 0 0 {name=l45 lab=VDD}
C {madvlsi/gnd.sym} 1390 -1030 0 0 {name=l49 lab=GND}
C {madvlsi/gnd.sym} 1710 -1030 0 0 {name=l53 lab=GND}
C {devices/lab_pin.sym} 1190 -1180 0 0 {name=l57 sig_type=std_logic lab=Q0}
C {madvlsi/pmos3.sym} 2030 -1180 0 0 {name=M5
L=0.15
W=1
body=VDD
nf=1
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 1870 -1180 0 0 {name=X21 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/nmos3.sym} 2030 -1060 0 0 {name=M6
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 1870 -1140 0 0 {name=l61 lab=GND}
C {madvlsi/vdd.sym} 1870 -1220 0 0 {name=l65 lab=VDD}
C {madvlsi/vdd.sym} 2030 -1210 0 0 {name=l69 lab=VDD}
C {madvlsi/gnd.sym} 2030 -1030 0 0 {name=l73 lab=GND}
C {madvlsi/pmos3.sym} 2350 -1180 0 0 {name=M7
L=0.15
W=1
body=VDD
nf=1
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 2190 -1180 0 0 {name=X22 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/nmos3.sym} 2350 -1060 0 0 {name=M8
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 2190 -1140 0 0 {name=l74 lab=GND}
C {madvlsi/vdd.sym} 2190 -1220 0 0 {name=l75 lab=VDD}
C {madvlsi/vdd.sym} 2350 -1210 0 0 {name=l77 lab=VDD}
C {madvlsi/gnd.sym} 2350 -1030 0 0 {name=l78 lab=GND}
C {madvlsi/pmos3.sym} 2670 -1180 0 0 {name=M9
L=0.15
W=1
body=VDD
nf=1
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 2510 -1180 0 0 {name=X23 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/nmos3.sym} 2670 -1060 0 0 {name=M10
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 2510 -1140 0 0 {name=l79 lab=GND}
C {madvlsi/vdd.sym} 2510 -1220 0 0 {name=l80 lab=VDD}
C {madvlsi/vdd.sym} 2670 -1210 0 0 {name=l81 lab=VDD}
C {madvlsi/gnd.sym} 2670 -1030 0 0 {name=l82 lab=GND}
C {madvlsi/pmos3.sym} 2990 -1180 0 0 {name=M11
L=0.15
W=1
body=VDD
nf=1
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 2830 -1180 0 0 {name=X24 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/nmos3.sym} 2990 -1060 0 0 {name=M12
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 2830 -1140 0 0 {name=l83 lab=GND}
C {madvlsi/vdd.sym} 2830 -1220 0 0 {name=l84 lab=VDD}
C {madvlsi/vdd.sym} 2990 -1210 0 0 {name=l85 lab=VDD}
C {madvlsi/gnd.sym} 2990 -1030 0 0 {name=l86 lab=GND}
C {madvlsi/pmos3.sym} 3310 -1180 0 0 {name=M13
L=0.15
W=1
body=VDD
nf=1
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 3150 -1180 0 0 {name=X25 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/nmos3.sym} 3310 -1060 0 0 {name=M14
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 3150 -1140 0 0 {name=l87 lab=GND}
C {madvlsi/vdd.sym} 3150 -1220 0 0 {name=l88 lab=VDD}
C {madvlsi/vdd.sym} 3310 -1210 0 0 {name=l89 lab=VDD}
C {madvlsi/gnd.sym} 3310 -1030 0 0 {name=l90 lab=GND}
C {madvlsi/pmos3.sym} 3630 -1180 0 0 {name=M15
L=0.15
W=1
body=VDD
nf=1
...
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 3470 -1180 0 0 {name=X26 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/nmos3.sym} 3630 -1060 0 0 {name=M16
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/gnd.sym} 3470 -1140 0 0 {name=l91 lab=GND}
C {madvlsi/vdd.sym} 3470 -1220 0 0 {name=l92 lab=VDD}
C {madvlsi/vdd.sym} 3630 -1210 0 0 {name=l93 lab=VDD}
C {madvlsi/gnd.sym} 3630 -1030 0 0 {name=l94 lab=GND}
C {devices/lab_pin.sym} 4290 -1100 1 0 {name=l95 sig_type=std_logic lab=Qout}
C {devices/lab_pin.sym} 1510 -1180 0 0 {name=l96 sig_type=std_logic lab=Q1}
C {devices/lab_pin.sym} 1360 -1060 0 0 {name=l97 sig_type=std_logic lab=Q8}
C {devices/lab_pin.sym} 1680 -1060 0 0 {name=l98 sig_type=std_logic lab=Q9}
C {devices/lab_pin.sym} 1830 -1180 0 0 {name=l99 sig_type=std_logic lab=Q2}
C {devices/lab_pin.sym} 2150 -1180 0 0 {name=l100 sig_type=std_logic lab=Q3}
C {devices/lab_pin.sym} 2000 -1060 0 0 {name=l101 sig_type=std_logic lab=Q10}
C {devices/lab_pin.sym} 2320 -1060 0 0 {name=l102 sig_type=std_logic lab=Q11}
C {devices/lab_pin.sym} 2470 -1180 0 0 {name=l103 sig_type=std_logic lab=Q4}
C {devices/lab_pin.sym} 2790 -1180 0 0 {name=l104 sig_type=std_logic lab=Q5}
C {devices/lab_pin.sym} 3110 -1180 0 0 {name=l105 sig_type=std_logic lab=Q6}
C {devices/lab_pin.sym} 3430 -1180 0 0 {name=l106 sig_type=std_logic lab=Q7}
C {devices/lab_pin.sym} 2640 -1060 0 0 {name=l107 sig_type=std_logic lab=Q12}
C {devices/lab_pin.sym} 2960 -1060 0 0 {name=l108 sig_type=std_logic lab=Q13}
C {devices/lab_pin.sym} 3280 -1060 0 0 {name=l109 sig_type=std_logic lab=Q14}
C {devices/lab_pin.sym} 3600 -1060 0 0 {name=l110 sig_type=std_logic lab=Q15}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 3980 -1100 0 0 {name=X27 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/inverter.sym} 4150 -1100 0 0 {name=X28 Wp=1 Lp=0.15 WW=1 LL=0.15}
C {madvlsi/gnd.sym} 3980 -1060 0 0 {name=l111 lab=GND}
C {madvlsi/vdd.sym} 3980 -1140 0 0 {name=l112 lab=VDD}
C {madvlsi/gnd.sym} 4150 -1060 0 0 {name=l113 lab=GND}
C {madvlsi/vdd.sym} 4150 -1140 0 0 {name=l114 lab=VDD}
C {devices/lab_pin.sym} 3860 -1100 1 0 {name=l115 sig_type=std_logic lab=Qout-pre-buffer}
C {devices/lab_pin.sym} 730 -560 1 0 {name=l5 sig_type=std_logic lab=Q16}
C {devices/lab_pin.sym} 730 -510 1 0 {name=l6 sig_type=std_logic lab=nQ16}
C {madvlsi/tt_models.sym} 330 -690 0 0 {
name=TT_MODELS
only_toplevel=false
