...
S {}
E {}
N 970 -520 1070 -520 { lab=#net1}
N 1250 -550 1400 -550 { lab=#net2}
N 1350 -570 1400 -570 { lab=CLK}
N 1470 -560 1540 -560 { lab=#net3}
N 1000 -580 1070 -580 { lab=GND}
N 1000 -580 1000 -570 { lab=GND}
...
N 1540 -440 1820 -440 { lab=#net3}
N 1540 -560 1540 -440 { lab=#net3}
...
N 750 -490 770 -490 { lab=#net4}
N 950 -520 970 -520 { lab=#net1}
N 890 -310 950 -310 { lab=#net1}
N 950 -520 950 -310 { lab=#net1}
N 740 -490 740 -310 { lab=#net4}
N 740 -310 830 -310 { lab=#net4}
N 590 -490 630 -490 { lab=GND}
N 690 -490 750 -490 { lab=#net4}
N 590 -550 630 -550 { lab=#net5}
N 690 -550 770 -550 { lab=#net6}
N 590 -490 590 -480 { lab=GND}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/diff_amp.sym} 1040 -550 0 0 {name=X2}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/and2.sym} 1370 -560 0 0 {name=X3}
C {madvlsi/gnd.sym} 1150 -450 0 0 {name=l3 lab=GND}
C {madvlsi/gnd.sym} 1430 -530 0 0 {name=l4 lab=GND}
C {madvlsi/vdd.sym} 1150 -650 0 0 {name=l6 lab=VDD}
C {madvlsi/vdd.sym} 1430 -590 0 0 {name=l7 lab=VDD}
C {devices/lab_pin.sym} 510 -530 0 0 {name=l8 sig_type=std_logic lab=Vref}
C {devices/lab_pin.sym} 1350 -570 0 0 {name=l10 sig_type=std_logic lab=CLK}
C {madvlsi/vsource.sym} 240 -120 0 0 {name=Vdd
value=1.8}
C {madvlsi/gnd.sym} 240 -90 0 0 {name=l23 lab=GND}
C {madvlsi/vdd.sym} 240 -150 0 0 {name=l26 lab=VDD}
C {madvlsi/gnd.sym} 340 -110 0 0 {name=l22 lab=GND}
C {devices/lab_pin.sym} 340 -170 0 0 {name=l25 sig_type=std_logic lab=CLK}
C {madvlsi/vsource.sym} 40 -130 0 0 {name=Vdd1
value=0}
...
C {devices/lab_pin.sym} 40 -160 1 0 {name=l12 sig_type=std_logic lab=Vref}
C {devices/lab_pin.sym} 130 -160 1 0 {name=l14 sig_type=std_logic lab=Vin}
C {madvlsi/gnd.sym} 1000 -570 0 0 {name=l9 lab=GND}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/mux2.sym} 550 -550 0 0 {name=X4}
C {devices/lab_pin.sym} 510 -570 0 0 {name=l15 sig_type=std_logic lab=Vin}
...
C {devices/lab_pin.sym} 550 -510 3 0 {name=l17 sig_type=std_logic lab=Q7}
...
C {devices/code_shown.sym} -230 -710 0 0 {name=SPICE only_toplevel=false value=".ic v(Q0)=0
.ic v(Q1)=0 
.ic v(Q2)=0 
.ic v(Q3)=0 
.ic v(Q4)=0 
...
C {madvlsi/capacitor.sym} 860 -310 1 0 {name=C1
value=5p
m=1}
C {/home/madvlsi/Documents/MADVLSI-Final_Project/schematic/diff_amp.sym} 740 -520 0 0 {name=X1}
C {madvlsi/gnd.sym} 850 -420 0 0 {name=l1 lab=GND}
C {madvlsi/vdd.sym} 850 -620 0 0 {name=l5 lab=VDD}
C {madvlsi/resistor.sym} 660 -490 1 0 {name=R1
value=1M
m=1}
C {madvlsi/capacitor.sym} 720 -580 2 0 {name=C2
value=5p
m=1}
C {madvlsi/resistor.sym} 660 -550 1 0 {name=R2
value=1M
m=1}
C {madvlsi/gnd.sym} 720 -610 2 0 {name=l56 lab=GND}
C {madvlsi/gnd.sym} 590 -480 0 0 {name=l2 lab=GND}
C {madvlsi/isource.sym} 790 -440 1 0 {name=I1
value=1u}
C {madvlsi/gnd.sym} 760 -440 0 0 {name=l38 lab=GND}
C {madvlsi/vsource.sym} 340 -140 0 0 {name=VCLK1
value="pulse(0 1.8 20u 1n 1n 2u 4u)"}
