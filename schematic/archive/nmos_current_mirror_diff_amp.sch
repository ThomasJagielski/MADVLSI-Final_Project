...
S {}
E {}
N 260 -440 720 -440 { lab=#net1}
N 230 -410 230 -260 { lab=#net1}
N 230 -200 230 -190 { lab=#net2}
N 230 -190 410 -190 { lab=#net2}
N 410 -200 410 -190 { lab=#net2}
N 330 -190 330 -180 { lab=#net2}
N 410 -320 410 -260 { lab=#net3}
N 440 -350 470 -350 { lab=#net3}
...
C {madvlsi/gnd.sym} 330 -120 0 0 {name=l1 lab=GND}
C {madvlsi/gnd.sym} 500 -120 0 0 {name=l2 lab=GND}
C {madvlsi/gnd.sym} 750 -120 0 0 {name=l3 lab=GND}
C {madvlsi/vdd.sym} 230 -470 0 0 {name=l4 lab=VDD}
