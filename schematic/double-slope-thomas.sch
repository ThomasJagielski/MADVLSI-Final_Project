...
N 890 -520 900 -520 { lab=Vout}
N 960 -520 1000 -520 { lab=#net7}
N 980 -540 980 -520 { lab=#net7}
N 980 -540 1070 -540 { lab=#net7}
N 1070 -540 1070 -520 { lab=#net7}
...
C {devices/lab_pin.sym} 360 -120 3 0 {name=l17 sig_type=std_logic lab=Q7}
...
C {devices/lab_pin.sym} 1070 -580 0 0 {name=l9 sig_type=std_logic lab=Vhalf}
C {madvlsi/resistor.sym} 930 -520 1 0 {name=R3
value=1k
m=1}
C {madvlsi/resistor.sym} 1000 -490 2 0 {name=R4
value=1k
m=1}
C {madvlsi/gnd.sym} 1000 -460 0 0 {name=l65 lab=GND}
